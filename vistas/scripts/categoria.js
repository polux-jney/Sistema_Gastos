...
function desactivar(idCategoria) {
	...
	var ventanaEleccion =toastr.warning('¿Deseas desactivar la categoria seleccionado?<br>'+
...
function activar(idCategoria) {
	var ventanaEleccion =toastr.warning('¿Deseas activar la categoria seleccionado?<br>'+
		'<button type="button" id=rptaSi class="btn btn-success">Si</button>'+
		'<button type="button" id=rptaNo class="btn btn-danger">No</button>',"Alerta");
